    ...
    async *emit(ctx, content) {
      ...
      const simplifiedIndex = Object.fromEntries(
        Array.from(linkIndex).map(([slug, content]) => [
          slug,
          // ponytail: Quick Jump only searches titles/tags. Restore links/filePath if the
          // stock Quartz Graph or Explorer components are added back to this site's layout.
          { title: content.title, tags: content.tags, content: "" },
        ]),
      )
