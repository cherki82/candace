---
title: "It's not the only set of prints on that gun"
description: "\"It's not the only set of prints on that gun\" — Candace Owens"
statement_id: "statement-bd3aff0b0a72"
...
> It's not the only set of prints on that gun
